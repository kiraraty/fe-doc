...
![在这里插入图片描述](https://s2.loli.net/2022/08/01/mvHaji6xfMdy2h1.png)
...
（5）应使用 "alt" 属性加以说明` 复制代码`当网络速度很慢，或者图片地址失效的时候，就可以体现出alt属性的作用，他可以让用户在图片没有显示的时候知道这个图片的作用。同时为图片设置高度和宽度，可提高页面的加载速度。
