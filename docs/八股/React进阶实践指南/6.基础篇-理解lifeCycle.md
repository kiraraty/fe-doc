...
React 在调和( render )阶段会**深度遍历 React fiber 树**，目的就是发现不同( diff )，不同的地方就是接下来需要更新的地方，对于变化的组件，就会执行 render 函数。在一次调和过程完毕之后，就到了commit 阶段，commit 阶段会创建修改真实的 DOM 节点。
...
<img src="https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/image-20220911231440165.png" alt="image-20220911231440165" style="zoom:80%;" />
...
<img src="https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/image-20220911231541976.png" alt="image-20220911231541976" style="zoom:67%;" />
...
<img src="https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/image-20220911231616464.png" alt="image-20220911231616464" style="zoom:67%;" />
...
<img src="https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/image-20220911232349168.png" alt="image-20220911232349168" style="zoom:67%;" />
