...
抽象 props 一般用于**跨层级传递 props** ，一般不需要具体指出 props 中某个属性，而是将 **props 直接传入或者是抽离到子组件**中。
...
![image-20220911223405223](https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/image-20220911223405223.png)
