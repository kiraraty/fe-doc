...
![img](https://s2.loli.net/2022/08/14/WCBPlsdiaDw8pRo.jpg)
...
![img](https://femarkdownpicture.oss-cn-qingdao.aliyuncs.com/Imgs/20191108114221672.png)
   ...
   方法二：利用generator 函数返回的[遍历](https://so.csdn.net/so/search?q=遍历&spm=1001.2101.3001.7020)器
